...
`spigotdl` - A small Bash CLI tool for downloading Spigot`.jar` files directly into a selected server's directory, managing batch downloads, and handling batch updates of multiple plugins in multiple servers.
